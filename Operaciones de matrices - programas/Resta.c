...
void Resta(int [][MAX], int [][MAX], int [][MAX], int, int);/*Prototipo de la función Suma que realizará la
                                                            resta de dos matrices y almacenará el resultado
...
/*Implementación de la función Suma que realiza la resta de dos matrices y almacena
el resultado en una tercera matriz.
-Esta función realiza la resta de dos arreglos bidimensionales M1 y M2 y guarda el resultado en el arreglo M3.
-Recorre los arreglos M1 y M2 utilizando dos bucles anidados.
-En cada posición (I, J), resta los elementos correspondientes de M1 y M2 y almacena el resultado en M3[I][J].
*/
